...
| **Server-side preview** | Executes the saved PHP through a **sandboxed subprocess** and renders output in a same-origin iframe. PHP errors / warnings / fatals are shown. **Timeout + memory caps enforced.** |
